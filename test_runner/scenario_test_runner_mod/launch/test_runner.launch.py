...
def default_rviz_config_file():
    ...
    #return Path(get_package_share_directory("autoware_launch")) / "rviz/scenario_simulator.rviz"

def launch_setup(context, *args, **kwargs):
    # fmt: off
    architecture_type                   = LaunchConfiguration("architecture_type",                      default="awf/universe/20250130")
    ...
    return [
        ...
        # fmt: on
        Node(
            package="scenario_test_runner_mod",
